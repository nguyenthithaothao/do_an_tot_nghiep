	...
	<div id="nd">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Quản Lý Loại địa điểm</h2>
			</div>
			<div class="panel-body">
				<a href="adddm.php">
					<button class="btn btn-success" style="margin-bottom: 15px">Thêm loại địa điểm</button>
				</a>
...
<?php
	...
	$sql = 'select * from place_categories where 1 '.$add.' limit '.$firstIndex.','.$limit;
$danhmuc = executeResult($sql);
$sql1 = 'select count(id) as tong from place_categories where 1 '.$add;
...
?>
	<tr>
				...
				<td>
					<a href="adddm.php?id=<?=$item['id']?>"><button class="btn btn-warning">Sửa</button></a>
				</td>
				<td>
